...
def generate_sql():
    df = pd.read_excel('backend/src/main/resources/Additional Delhi_Data.xlsx', header=0)
    ...
    with open('delhi_data.sql', 'w', encoding='utf-8') as f:
        f.writelines(sql_lines)
        
    print("delhi_data.sql generated successfully.")
